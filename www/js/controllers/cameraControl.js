    ...
    function (
      ...
      function onSuccess(result) {
        ...
        if (btnWhere == "other") {
          ...
          var waitImg = setInterval(function () {
            checkImg();
          }, 1500);
        }
      }
      ...
      $scope.btnUpload = function (fileData) {
        ...
        //auto gen ID
        jobsRecMeta =
          jobInfo.jobProv + "_" + jobInfo.jobArea + "_" + jobInfo.jobPin;
        ...
        if (btnWhere == "other") {
          ...
          refBMONimg.putString(fileData, "base64").then(function (snapshot) {
            ...
            refJobsRec
              .child(jobInfo.jobId + "/imgOther")
              .push({ name: imgName, note: otherPhotoNote });
            setTimeout(function () {
              $scope.hideLoading();
          ...
          refBMONimg.putString(fileData, "base64").then(
            function (snapshot) {
              imgDB
                .child("4d")
                .push({
              ...
              setTimeout(function () {
                if (btnWhere == "front") {
                  ...
                  refJobsRec
                    .child(jobInfo.jobId + "/img4d")
                    .update({ front: imgName });
                  $scope.showMessage("บันทึกภาพแล้ว");
