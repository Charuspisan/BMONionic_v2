...
.controller('getjobsCtrl', function($scope, $firebaseObject, $firebaseArray, $ionicPopup, $timeout, $location, $window, sharedProp, $ionicLoading, $cordovaGeolocation) {
...
function onDeviceReady() {
  ...
  //     });
    ...
    $scope.goPage = function(parentJobId,refJobsID,pin,prov,area,date,tool,locate) {
    	sharedProp.setJobInfo(parentJobId,refJobsID,pin,prov,area,date,tool,locate);
      $scope.showLoading();
...
function onSuccess(result) {
  ...
  var dateRec = dd+"-"+mm+"-"+yyyy;
      ...
      refBMONimg.putString(fileData, 'base64').then(function(snapshot) {
          ...
          imgDB.child("etc").push({"date":dateRec,"lat":latImg,"lng":lngImg,"user":userEmail,"name":imgName,"status":"new","type":"etc","note":etcPhotoNote});
          setTimeout(function(){
            $scope.hideLoading();
      ...
      buttons: [
        ...
        },
        {
          ...
          onTap: function(e) {
            ...
            if(etcPhotoNote==undefined||etcPhotoNote==null||etcPhotoNote==""){
